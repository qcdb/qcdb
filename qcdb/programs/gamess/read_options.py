...
def load_gamess_keywords(options: Keywords) -> None:
    ...
    options.add(
        ...
        Keyword(
            ...
            glossary="""Grand total memory needed for the distributed data interface (DDI) storage, given in units of 1000^2 words.""",
        ),
    )
    ...
    options.add(
        ...
        Keyword(
            ...
            default="none",
            validator=parsers.enum("NONE B3LYP PBE0 PBE B3LYPV1R B3LYPV3"),
            glossary="""""",
        ),
    )

    options.add(
        "gamess", Keyword(keyword="contrl__mplevl", default=2, validator=parsers.intenum("0 2"), glossary="""""")
    )
    ...
    options.add(
        "gamess",
        Keyword(
            keyword="contrl__maxit", default=30, validator=parsers.positive_integer, glossary=""""""  # psi4 maxiter
        ),
    )
    ...
    options.add(
        "gamess", Keyword(keyword="contrl__mult", default=1, validator=parsers.positive_integer, glossary="""""")
    )
    ...
    options.add(
        "gamess",
        Keyword(
            keyword="basis__gbasis", default="sto", validator=parsers.enum("STO N21 N31 N311 G3L G3LX"), glossary=""""""
        ),
    )
