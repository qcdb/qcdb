...
def test_sp_rhf_ccsd_t_ecc(h2o):
    ...
    h2o = qcdb.set_molecule(h2o)
    qcdb.set_options({"cfour_BASIS": "qz2p", "cfour_SCF_CONV": 12, "cfour_CC_CONV": 12, "cfour_cc_program": "ecc"})
...
def test_sp_rhf_ccsd_t_(h2o):
    ...
    h2o = qcdb.set_molecule(h2o)
    qcdb.set_options({"cfour_BASIS": "qz2p", "cfour_SCF_CONV": 12, "cfour_CC_CONV": 12, "cfour_cc_program": "vcc"})
