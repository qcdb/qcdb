...
""")
    ...
    E, jrec = qcdb.energy('c4-hf/cc-pVDZ', molecule=h2o, return_wfn=True)
...
""")
    ...
    E, jrec = qcdb.energy ('c4-hf', return_wfn=True)
    print(qcdb.print_variables())
...
#                      'scf_type': 'pk'})
#
#    E, jrec = qcdb.energy ('c4-scf', return_wfn=True, probe=True)
#    print(qcdb.print_variables())
#
