...
ref_grad_scf_tz = np.array([[0.0, 0.0, 0.01246097], [0.0, 0.0, -0.01246097]])
...
ref_grad_scf_dtz = np.array([[0.0, 0.0, 0.01249265], [0.0, 0.0, -0.01249265]])
ref_hess_scf_dtz = np.array(
    [
        [-0.00367267, 0.0, 0.0, 0.00367267, 0.0, 0.0],
        [0.0, -0.00367267, 0.0, 0.0, 0.00367267, 0.0],
        [0.0, 0.0, 0.02784783, 0.0, 0.0, -0.02784783],
        [0.00367267, 0.0, 0.0, -0.00367267, 0.0, 0.0],
        [0.0, 0.00367267, 0.0, 0.0, -0.00367267, 0.0],
        [0.0, 0.0, -0.02784783, 0.0, 0.0, 0.02784783],
    ]
...
ref_grad_scf_dtqz = np.array([[0.0, 0.0, 0.01244412], [0.0, 0.0, -0.01244412]])
ref_hess_scf_dtqz = np.array(
    [
        [-0.00365852, 0.0, 0.0, 0.00365852, 0.0, 0.0],
        [0.0, -0.00365852, 0.0, 0.0, 0.00365852, 0.0],
        [0.0, 0.0, 0.02798016, 0.0, 0.0, -0.02798016],
        [0.00365852, 0.0, 0.0, -0.00365852, 0.0, 0.0],
        [0.0, 0.00365852, 0.0, 0.0, -0.00365852, 0.0],
        [0.0, 0.0, -0.02798016, 0.0, 0.0, 0.02798016],
    ]
...
ref_grad_mp2_dtz = np.array([[0.0, 0.0, 0.01155124], [0.0, 0.0, -0.01155124]])
ref_hess_mp2_dtz = np.array(
    [
        [-0.00339591, 0.0, 0.0, 0.00339591, 0.0, 0.0],
        [0.0, -0.00339591, 0.0, 0.0, 0.00339591, 0.0],
        [0.0, 0.0, 0.02630844, 0.0, 0.0, -0.02630844],
        [0.00339591, 0.0, 0.0, -0.00339591, 0.0, 0.0],
        [0.0, 0.00339591, 0.0, 0.0, -0.00339591, 0.0],
        [0.0, 0.0, -0.02630844, 0.0, 0.0, 0.02630844],
    ]
...
ref_mp2_dtz_y = np.array([[0.0, -0.01155124, 0.0], [0.0, 0.01155124, 0.0]])
...
def test_1a():
    ...
    assert compare_arrays(ref_hess_scf_dz, qcdb.variable("CURRENT HESSIAN"), 6, lbl)
    ...
    assert compare_arrays(ref_scf_dz, qcdb.variable("CURRENT GRADIENT"), 6, lbl)
...
def test_1c():
    ...
    assert compare_arrays(ref_hess_scf_dz_y, qcdb.variable("CURRENT HESSIAN"), 6, lbl)
    ...
    assert compare_arrays(ref_scf_dz_y, qcdb.variable("CURRENT GRADIENT"), 6, lbl)
...
def test_4a():
    ...
    assert compare_arrays(ref_hess_scf_dtz, qcdb.variable("CURRENT HESSIAN"), 6, lbl)
    ...
    assert compare_arrays(ref_grad_scf_dtz, qcdb.variable("CURRENT GRADIENT"), 6, lbl)
    assert compare_values(ref_e_scf_dtz, qcdb.variable("CURRENT ENERGY"), 6, lbl)
...
def test_5a():
    ...
    assert compare_arrays(ref_hess_scf_dtqz, qcdb.variable("CURRENT HESSIAN"), 6, lbl)
    ...
    assert compare_arrays(ref_grad_scf_dtqz, qcdb.variable("CURRENT GRADIENT"), 6, lbl)
    assert compare_values(ref_e_scf_dtqz, qcdb.variable("CURRENT ENERGY"), 6, lbl)
...
def test_6a():
    ...
    assert compare_arrays(ref_hess_mp2_dtz, qcdb.variable("CURRENT HESSIAN"), 6, lbl)
    ...
    assert compare_arrays(ref_grad_mp2_dtz, qcdb.variable("CURRENT GRADIENT"), 6, lbl)
    assert compare_values(ref_e_mp2_dtz, jrec["qcvars"]["CURRENT ENERGY"].data, 6, lbl)
    assert compare_values(ref_e_mp2_dtz, qcdb.variable("CURRENT ENERGY"), 6, lbl)
