...
dip_z = np.array([1.52054865, 1.52054865, 0.0])
grad_z = np.array([[-0.04159183, -0.04159183, -0.0], [0.01821547, 0.02337636, 0.0], [0.02337636, 0.01821547, 0.0]])
dip_y = np.array([1.52054865, 0.0, 1.52054865])
grad_y = np.array([[0.01821547, 0.0, 0.02337636], [-0.04159183, 0.0, -0.04159183], [0.02337636, 0.0, 0.01821547]])
