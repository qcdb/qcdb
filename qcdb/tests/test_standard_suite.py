...
_q7 = (qcng.exceptions.UnknownError, "CALCLEVEL LCCD not implemented for ROHF references.", "no ROHF LCCD in GAMESS.")
_q8 = (qcng.exceptions.UnknownError, "select_lccd: Method 'lccd' with CC_TYPE 'CONV' and REFERENCE 'ROHF' not available", "no conv ROHF LCCD in Psi4.")
_q9 = (KeyError, "gms-lccsd", "no LCCSD in GAMESS.")
_q10 = (qcng.exceptions.InputError, "lccsd requires 'reference rhf'.", "no non-RHF LCCSD in Psi4.")
_q11 = (qcng.exceptions.InputError, "Invalid type 'CONV' for DFOCC", "no conv CCD in Psi4.")
...
_q29 = (qcng.exceptions.UnknownError, r"select_ccsd_at_: Method 'a-ccsd\(t\)' with CC_TYPE 'CONV' and REFERENCE 'UHF' not available", "no UHF a-CCSD(T) in Psi4.")
_q30 = (KeyError, r"gms-mp4\(sdq\)", "no MP4(SDQ) in GAMESS.")
_q31 = (KeyError, r"nwc-mp4\(sdq\)", "no specialty MP4(SDQ) in NWChem.")
_q32 = (qcng.exceptions.InputError, r"mp4\(sdq\) requires 'reference rhf'", "no non-RHF MP4(SDQ) in Psi4.")
_q33 = (KeyError, "gms-mp4", "no full MP4 in GAMESS.")
_q34 = (qcng.exceptions.UnknownError, "select_mp4: Method 'mp4' with MP_TYPE 'CONV' and REFERENCE", "only detci for conv ROHF MP4 in Psi4, and it's already peculiar for MP2.")
...
_q39 = (qcng.exceptions.UnknownError, "select_cisd: Method 'cisd' with CI_TYPE 'CONV' and REFERENCE 'UHF' not available", "no UHF CI in Psi4.")
_q40 = (qcng.exceptions.InputError, "CI IS NOT AVAILABLE FOR UHF WAVEFUNCTIONS.", "no UHF CI in GAMESS.")
_q41 = (qcng.exceptions.InputError, "qcisd requires 'reference rhf'.", "no non-RHF QCISD in Psi4.")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({"call": "gms-mp2", "reference": "rhf",  "fcae": "ae", "keywords": {"gamess_mp2__nacore": 0},                                                                                      }, id="mp2  rhf ae: gamess",           marks=using("gamess")),
        ...
        pytest.param({"call": "gms-mp2", "reference": "rhf",  "fcae": "fc", "keywords": {}                                                                                                              }, id="mp2  rhf fc: gamess",           marks=using("gamess")),
        ...
        pytest.param({"call": "gms-mp2", "reference": "uhf",  "fcae": "ae", "keywords": {"gamess_contrl__scftyp": "uhf", "gamess_mp2__nacore": 0},                                                      }, id="mp2  uhf ae: gamess",           marks=using("gamess")),
        ...
        pytest.param({"call": "gms-mp2", "reference": "uhf",  "fcae": "fc", "keywords": {"gamess_contrl__scftyp": "uhf"},                                                                               }, id="mp2  uhf fc: gamess",           marks=using("gamess")),
        ...
        pytest.param({"call": "gms-mp2", "reference": "rohf", "fcae": "ae", "keywords": {"gamess_contrl__scftyp": "rohf", "gamess_mp2__nacore": 0, "gamess_mp2__ospt": "RMP"},                          }, id="mp2 rohf ae: gamess",           marks=using("gamess")),
        ...
        pytest.param({"call": "gms-mp2", "reference": "rohf", "fcae": "fc", "keywords": {"gamess_contrl__scftyp": "rohf", "gamess_mp2__ospt": "RMP"},                                                   }, id="mp2 rohf fc: gamess",           marks=using("gamess")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({"call": "c4-mp2",  "reference": "rohf", "fcae": "ae",                        "keywords": {**_c4_tight, "cfour_reference": "rohf"},                                                                                 }, id="mp2 rohf ae: cfour",          marks=using("cfour")),
        pytest.param({"call": "gms-mp2", "reference": "rohf", "fcae": "ae",                        "keywords": {"gamess_contrl__scftyp": "rohf", "gamess_mp2__nacore": 0, "gamess_system__memddi": 300},               "wrong": {1: _w5} }, id="mp2 rohf ae: gamess",         marks=using("gamess")),
        ...
        pytest.param({"call": "c4-mp2",  "reference": "rohf", "fcae": "fc",                        "keywords": {**_c4_tight, "cfour_reference": "rohf", "cfour_dropmo": [1]},                                                            }, id="mp2 rohf fc: cfour",          marks=using("cfour")),
        pytest.param({"call": "gms-mp2", "reference": "rohf", "fcae": "fc",                        "keywords": {"gamess_contrl__scftyp": "rohf", "gamess_system__memddi": 300},                                        "wrong": {1: _w5} }, id="mp2 rohf fc: gamess",         marks=using("gamess")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({"call": "p4-mp3",  "reference": "uhf",  "fcae": "ae",                        "keywords": {"reference": "uhf", "psi4_qc_module": "occ", "psi4_mp_type": "conv"},                                                       }, id="mp3  uhf ae: psi4-occ",   marks=using("psi4")),
        # DEBUG pytest.param({"call": "p4-mp3",  "reference": "uhf",  "fcae": "ae", "xptd": {"fd": False}, "keywords": {**_p4_fd, "reference": "uhf", "psi4_mp_type": "conv", "psi4_dertype": "none"},                                      }, id="mp3  uhf ae: psi4",       marks=using("psi4")),
        ...
        # DEBUG pytest.param({"call": "p4-mp3",  "reference": "uhf",  "fcae": "fc", "xptd": {"fd": False}, "keywords": {**_p4_fd, "reference": "uhf", "psi4_freeze_core": True, "psi4_mp_type": "conv", "psi4_dertype": "none"},            }, id="mp3  uhf fc: psi4",       marks=using("psi4")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({"call": "c4-cisd",  "reference": "rohf", "fcae": "ae", "keywords": {**_c4_tight, "cfour_REFerence": "roHF", "cfour_cc_program": "vcc", "cfour_print": 2},                                                             }, id="cisd rohf ae: cfour-vcc",  marks=using("cfour")),
        ...
        pytest.param({"call": "nwc-cisd", "reference": "rohf", "fcae": "ae", "keywords": {"nwchem_scf__rohf": True, "qc_module": "tce"},                                                                                                    }, id="cisd rohf ae: nwchem-tce", marks=using("nwchem")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # uncertain rohf reference values: cfour == nwc-tce, but those != p4n. cfour says rohf nyi
        pytest.param({"call": "c4-lccsd",  "reference": "rohf", "fcae": "ae", "keywords": {**_c4_tight, "cfour_REFerence": "roHF", "cfour_cc_program": "vcc", "cfour_print": 2},                                                             "wrong": {0: _w29}}, id="lccsd rohf ae: cfour-vcc",  marks=using("cfour")),
        ...
        pytest.param({"call": "nwc-lccsd", "reference": "rohf", "fcae": "ae", "keywords": {"qc_module": "tce", "nwchem_scf__rohf": True},                                                                                                    "wrong": {0: _w29}}, id="lccsd rohf ae: nwchem-tce", marks=using("nwchem")),
        ...
        pytest.param({"call": "c4-lccsd",  "reference": "rohf", "fcae": "fc", "keywords": {**_c4_tight, "cfour_REFerence": "roHF", "cfour_dropmo": [1], "cfour_orbitals": 0, "cfour_cc_program": "vcc", "cfour_print": 2},                   "wrong": {0: _w29}}, id="lccsd rohf fc: cfour-vcc",  marks=using("cfour")),
        ...
        pytest.param({"call": "nwc-lccsd", "reference": "rohf", "fcae": "fc", "keywords": {"nwchem_scf__rohf": True, "nwchem_tce__freeze": 1, "qc_module": "tce"},                                                                           "wrong": {0: _w29}}, id="lccsd rohf fc: nwchem-tce", marks=using("nwchem")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({"call": "c4-ccd",  "reference": "rohf", "fcae": "ae", "keywords": {**_c4_tight, "cfour_REFerence": "roHF", "cfour_cc_program": "vcc", "cfour_print": 2},                                                          }, id="ccd rohf ae: cfour-vcc",  marks=using("cfour")),
        ...
        pytest.param({"call": "nwc-ccd", "reference": "rohf", "fcae": "ae", "keywords": {"nwchem_scf__rohf": True, "qc_module": "tce"},                                                                                                 }, id="ccd rohf ae: nwchem-tce", marks=using("nwchem")),
        ...
        pytest.param({"call": "c4-ccd",  "reference": "rohf", "fcae": "fc", "keywords": {**_c4_tight, "cfour_REFerence": "roHF", "cfour_dropmo": [1], "cfour_orbitals": 0, "cfour_cc_program": "vcc", "cfour_print": 2},                }, id="ccd rohf fc: cfour-vcc",  marks=using("cfour")),
        ...
        pytest.param({"call": "nwc-ccd", "reference": "rohf", "fcae": "fc", "keywords": {"nwchem_scf__rohf": True, "nwchem_tce__freeze": 1, "qc_module": "tce"},                                                                        }, id="ccd rohf fc: nwchem-tce", marks=using("nwchem")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({"call": "c4-ccsd",  "reference": "rohf", "fcae": "fc",                        "keywords": {**_c4_tight, "cfour_reference": "rohf", "cfour_dropmo": 1, "cfour_cc_program": "ecc", "cfour_print": 2, "cfour_pert_orb": 0}, "wrong": {1: _w12}}, id="ccsd rohf fc: cfour-ecc",  marks=using("cfour")),
        ...
        pytest.param({"call": "nwc-ccsd", "reference": "rohf", "fcae": "fc", "xptd": {"fd": True},  "keywords": {"nwchem_tce__freeze": 1, "nwchem_scf__rohf": True, "qc_module": "tce"},                                                                         }, id="ccsd rohf fc: nwchem-tce", marks=using("nwchem")),
        ...
        # DEBUG pytest.param({"call": "p4-ccsd",  "reference": "rohf", "fcae": "fc", "keywords": {"reference": "rohf", "psi4_cc_type": "conv", "psi4_freeze_core": True, **_p4_fd, "psi4_dertype": "none"},                                                      }, id="ccsd rohf fc: psi4-cc",       marks=using("psi4")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({"call": "nwc-ccsd", "reference": "rhf",  "fcae": "fc", "xptd": {"fd": True},  "keywords": {"nwchem_tce__freeze": 1, "qc_module": "tce"},                                                                                 }, id="ccsd  rhf fc: nwchem-tce", marks=using("nwchem")),
        pytest.param({"call": "p4-ccsd",  "reference": "rhf",  "fcae": "fc", "xptd": {"fd": False},  "keywords": {**_p4_fd, "psi4_freeze_core": True, "psi4_cc_type": "conv", "psi4_dertype": "none"},                                          }, id="ccsd  rhf fc: psi4",       marks=using("psi4")),  # FD SWITCH
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({"call": "p4-ccsd(t)",  "reference": "uhf",  "fcae": "ae", "keywords": {"reference": "uhf", "qc_module": "ccenergy"},                                                                                                                                                        }, id="ccsd_t_  uhf ae: psi4",       marks=using("psi4")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({"call": "p4-ccsd(t)",  "reference": "rhf",  "fcae": "ae",                      "keywords": {"qc_module": "ccenergy"},                                                                                                                     }, id="ccsd_t_  rhf ae: psi4-cc",    marks=using("psi4")),
        # DEBUG pytest.param({"call": "p4-c4-ccsd(t)", "reference": "rhf", "fcae": "ae", "keywords": {**_p4c4_fd, "psi4_cfour_reference": "rhf", "psi4_cfour_cc_program": "ncc", "psi4_dertype": "none"},                                                       }, id="ccsd_t_  rhf ae: psi4-cfour-ncc"),
        ...
        # DEBUG pytest.param({"call": "p4-c4-ccsd(t)", "reference": "rhf", "fcae": "fc", "keywords": {**_p4c4_fd, "psi4_cfour_reference": "rhf", "psi4_cfour_dropmo": [1], "psi4_cfour_cc_program": "ncc", "psi4_dertype": "none"},                             }, id="ccsd_t_  rhf fc: psi4-cfour-ncc"),
        ...
        # DEBUG pytest.param({"call": "p4-c4-ccsd(t)", "reference": "uhf", "fcae": "ae", "keywords": {**_p4c4_fd, "psi4_cfour_reference": "uhf", "psi4_cfour_cc_program": "vcc", "psi4_dertype": "none"},                                                       }, id="ccsd_t_  uhf ae: psi4-cfour-vcc"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({"call": "nwc-ccsd(t)", "reference": "rhf",  "fcae": "ae", "xptd": {"fd": True},  "keywords": {"qc_module": "tce"},                                                                                                                        }, id="ccsd_t_  rhf ae: nwchem-tce", marks=using("nwchem")),
        pytest.param({"call": "p4-ccsd(t)",  "reference": "rhf",  "fcae": "ae", "xptd": {"fd": False},  "keywords": {**_p4_fd, "qc_module": "ccenergy", "psi4_dertype": "none"},                                                                                                         }, id="ccsd_t_  rhf ae: psi4-cc",    marks=using("psi4")),  # FD SWITCH
        # DEBUG pytest.param({"call": "p4-c4-ccsd(t)", "reference": "rhf", "fcae": "ae", "keywords": {**_p4c4_fd, "psi4_cfour_reference": "rhf", "psi4_cfour_cc_program": "ncc", "psi4_dertype": "none"},                                                       }, id="ccsd_t_  rhf ae: psi4-cfour-ncc"),
        ...
        pytest.param({"call": "nwc-ccsd(t)", "reference": "rhf",  "fcae": "fc", "xptd": {"fd": True},  "keywords": {"nwchem_tce__freeze": 1, "qc_module": "tce"},                                                                                               }, id="ccsd_t_  rhf fc: nwchem-tce", marks=using("nwchem")),
        pytest.param({"call": "p4-ccsd(t)",  "reference": "rhf",  "fcae": "fc", "xptd": {"fd": False},  "keywords": {**_p4_fd, "psi4_freeze_core": True, "qc_module": "ccenergy", "psi4_dertype": "none"},                                                       }, id="ccsd_t_  rhf fc: psi4-cc",    marks=using("psi4")),  # FD SWITCH
        # DEBUG pytest.param({"call": "p4-c4-ccsd(t)", "reference": "rhf", "fcae": "fc", "keywords": {**_p4c4_fd, "psi4_cfour_reference": "rhf", "psi4_cfour_dropmo": [1], "psi4_cfour_cc_program": "ncc", "psi4_dertype": "none"},                             }, id="ccsd_t_  rhf fc: psi4-cfour-ncc"),
        ...
        pytest.param({"call": "p4-ccsd(t)",  "reference": "uhf",  "fcae": "ae", "xptd": {"fd": False},  "keywords": {**_p4_fd, "reference": "uhf", "qc_module": "ccenergy", "psi4_dertype": "none"},                                                             }, id="ccsd_t_  uhf ae: psi4-cc",    marks=using("psi4")),  # FD SWITCH
        # DEBUG pytest.param({"call": "p4-c4-ccsd(t)", "reference": "uhf", "fcae": "ae", "keywords": {**_p4c4_fd, "psi4_cfour_reference": "uhf", "psi4_cfour_cc_program": "vcc", "psi4_dertype": "none"},                                                       }, id="ccsd_t_  uhf ae: psi4-cfour-vcc"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({"call": "p4-ccsdt",  "reference": "rhf",  "fcae": "ae", "keywords": {},                                                                                                                               "error": {0: _q21}}, id="ccsdt  rhf ae: psi4",       marks=using("psi4")),
        ...
        pytest.param({"call": "c4-ccsdt",  "reference": "rohf", "fcae": "ae", "keywords": {**_c4_tight, "cfour_reference": "rohf", "cfour_cc_program": "vcc"},                                                                                }, id="ccsdt rohf ae: cfour-vcc",  marks=using("cfour")),
        pytest.param({"call": "nwc-ccsdt", "reference": "rohf", "fcae": "ae", "keywords": {"nwchem_scf__rohf": True, "qc_module": "tce"},                                                                                                     }, id="ccsdt rohf ae: nwchem-tce", marks=using("nwchem")),

        pytest.param({"call": "c4-ccsdt",  "reference": "rohf", "fcae": "fc", "keywords": {**_c4_tight, "cfour_reference": "rohf", "cfour_dropmo": 1, "cfour_cc_program": "vcc", "cfour_orbitals": 0},                                        }, id="ccsdt rohf fc: cfour-vcc",  marks=using("cfour")),
        pytest.param({"call": "nwc-ccsdt", "reference": "rohf", "fcae": "fc", "keywords": {"nwchem_scf__rohf": True, "nwchem_tce__freeze": 1, "qc_module": "tce"},                                                                            }, id="ccsdt rohf fc: nwchem-tce", marks=using("nwchem")),
        # yapf: enable
    ],
)
