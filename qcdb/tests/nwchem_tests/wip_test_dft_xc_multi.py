...
@using("nwchem")
def test_1_pw91(h2o):
    qcdb.set_options({"basis": "cc-pvdz", "nwchem_dft__xc": "xperdew91 perdew91"})
...
@using("nwchem")
def test_3_bp86(h2o):
    qcdb.set_options({"basis": "cc-pvdz", "nwchem_dft__xc": "becke88 perdew86"})
...
@using("nwchem")
def test_4_bp91(h2o):
    qcdb.set_options({"basis": "cc-pvdz", "nwchem_dft__xc": "becke88 perdew91"})
...
@using("nwchem")
def test_6_b97(h2o):
    qcdb.set_options({"basis": "cc-pvdz", "nwchem_dft__xc": "becke97 hfexch 0.1943"})
...
def test_7_mpw1pw(h2o):
    qcdb.set_options({"basis": "cc-pvdz", "nwchem_dft__xc": "mpw91 0.75 hfexch 0.25 perdew91"})
...
def test_8_mpwlyp1m(h2o):
    qcdb.set_options({"basis": "cc-pvdz", "nwchem_dft__xc": "mpw91 0.95 hfexch 0.05 lyp"})
...
def test_9_mpwlyp1w(h2o):
    qcdb.set_options({"basis": "cc-pvdz", "nwchem_dft__xc": "mpw91 vwn_5 0.12 lyp 0.88"})
...
def test_11_b1pw91(h2o):
    qcdb.set_options({"basis": "cc-pvdz", "nwchem_dft__xc": "hfexch 0.25 becke88 0.75 perdew91"})
...
def test_12_b2plyp(h2o):
    qcdb.set_options({"basis": "cc-pvdz", "nwchem_dft__xc": "hfexch 0.53 becke88 0.47 lyp 0.73"})
...
def test_13_b3lyp5(h2o):
    qcdb.set_options({"basis": "cc-pvdz", "nwchem_dft__xc": "hfexch 0.2 slater 0.8 becke88 0.72 vwn_5 0.190 lyp 0.81"})
...
def test_14_b86bpbe(h2o):
    qcdb.set_options({"basis": "cc-pvdz", "nwchem_dft__xc": "becke86 cpbe96"})
...
def test_15_b97_1(h2o):
    qcdb.set_options({"basis": "cc-pvdz", "nwchem_dft__xc": "becke97gga1 hfexch"})
