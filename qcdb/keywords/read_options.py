...
def load_qcdb_keywords(options: Keywords) -> None:
    ...
    options.add(
        'qcdb',
        Keyword(keyword='translate_qcdb',
                default=True,
    ...
    options.add(
        ...
        Keyword(  # derived shorthand global
            ...
            validator=parsers.parse_convergence,
            glossary=
            'Convergence criterion for SCF density (psi: which is defined as the RMS value of the orbital gradient.'))
  ...
  **Cfour Interface:** Keyword translates into |cfour__cfour_spherical|."""))
    ...
    **Cfour Interface:** Keyword translates into |cfour__cfour_scf_maxcyc|."""))
    ...
    options.add(
        'qcdb',
        Keyword(keyword='scf__damping_percentage',
                default=0.0,
    ...
    options.add(
        'qcdb',
        Keyword(keyword='writer_file_label',
                default='',
...
"""))
    ...
    options.add(
        'qcdb',
        Keyword(keyword='max_force_g_convergence',
                default=3.e-4,
                validator=parsers.parse_convergence,
